...
from FireApp.models import Category, Post
...
class RegisterForm(forms.ModelForm):
    ...
    password_confirm = forms.CharField(label='password', max_length=100, required=True)   
...
class ForgotPasswordForm(forms.Form):
    ...
    def clean(self):
        ...
        if not User.objects.filter(email=email).exists():
            raise forms.ValidationError("No User Registerr with this Email")        
...
class PostForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if content and len(content) < 15:
            raise forms.ValidationError("Content must be 15 character")
    ...
    def save(self, commit = ...):
        ...
        if cleaned_data.get('img_url'):
            ...
            img_url="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/500px-No_image_available.svg.png?20251111182856"
